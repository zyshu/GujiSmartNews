 ...
 * des:关注
 */
public class ProfileMainFragment extends BaseFragment implements ProfileCareContract.View {
    ...
    private  List<ProfileCareModel.Profile_data_list> profileList;
...
//    CustomRoundAngleImageView ivAvatar10;
...
//        sf.mTitle = title;
    ...
    public void initPresenter() {
        _profileCarePresenterimpl = new ProfileCarePresenterimpl(getActivity(), this);
    }
...
//        mRecyclerView.setNestedScrollingEnabled(false);
        ...
        _profileCarePresenterimpl.getData();
...
//        mFakeStatusBar.setBackgroundColor(color);
     ...
     */
    @Override
    public void setData(ProfileCareModel data) {
        if (data == null) {
            return;
        }
        List<ProfileCareModel.Profile_data_list> profile_data_list = data.profile_data_list;
...
//            mRecyclerView.scrollToPosition(mAdapter.getItemCount() - 1);
    ...
    @Override
    public void setDataWares(ProfileCareModel data) {

    }

    @Override
    public void setDataMoreWares(ProfileCareModel data) {
...
//            helper.setBgColor(R.id.item_tv, c[position % 3]);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        try {
            if (getUserVisibleHint()) {//界面可见时
                ILog.e(TAG2, "getUserVisibleHint() ProfileMainFragment:" + isVisibleToUser);
            } else {
                ILog.e(TAG2, "[else]getUserVisibleHint() ProfileMainFragment:" + isVisibleToUser);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (isVisibleToUser) {//展示，可见   // 相当于onResume()方法--获取焦点
            ILog.e(TAG2, "isVisibleToUser ProfileMainFragment:" + isVisibleToUser);
        } else {
            // 相当于onpause()方法---失去焦点
            ILog.e(TAG2, "[else]isVisibleToUser ProfileMainFragment:" + isVisibleToUser);
        }
    }
    ...
    public void onResume() {
        super.onResume();
        ILog.e(TAG2, "isVisibleToUser VideoMainFragment  onResume---------------");
    }
