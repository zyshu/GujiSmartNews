 ...
 * 头条推荐
 */
public class HomeGXFragment extends BaseFragment implements HeaderView.RefreshDistanceListener, HomeHotTopContract.View, OnRefreshListener {
    private static int SIZE = 20;
    private int mStartPage = 1;
    private Context mContext;
    private static final String TAG = HomeGXFragment.class.getSimpleName();
    ...
    private String TAG1 = HomeGXFragment.class.getSimpleName();


    public static HomeGXFragment getInstance(String title, int homeHotType) {
        HomeGXFragment homeHotTopFragment = new HomeGXFragment();
