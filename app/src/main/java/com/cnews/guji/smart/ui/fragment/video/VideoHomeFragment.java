 ...
 * 视频专区
 */
public class VideoHomeFragment extends BaseFragment implements OnRefreshListener, VideoNewsContract.View, BaseQuickAdapter.RequestLoadMoreListener {
    private static int SIZE = 20;
    private int mStartPage = 1;
    private VideoNewsPresenterimpl _videoNewsPresenterimpl;
    private VideoNewsAdapter mAdapter;
    private List<VideoNewsModel.Articles> data = new ArrayList<>();
    ...
    public void initPresenter() {
        _videoNewsPresenterimpl = new VideoNewsPresenterimpl(getActivity(), this);
    }
...
//        mArticleImg.setImageURI(avatarUrl);
    ...
    protected void initData() {
        setRefreshBg();
        _videoNewsPresenterimpl.getVideoData(flag,videoFrType);
        flag = 0;
...
//                mSwipeToLoadLayout.setRefreshing(false);
     ...
     */
    @Override
    public void setVideoData(VideoNewsModel data) {
        if (data == null) {
     ...
     */
    @Override
    public void setVideoWares(VideoNewsModel data) {
     ...
     */
    @Override
    public void setVideoMoreWares(VideoNewsModel data) {
        if (data != null) {
            ILog.e("videomore","loadMore:"+new Gson().toJson(data));
            ILog.e("videomore","setVideoMoreWares------------------------->2..");
        ...
        mRecyclerView.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (mAdapter.getData().size() >= intSize * 2) {
                    ...
                    _videoNewsPresenterimpl.getVideoMoreWares(videoFrType);
                }
            }
        }, 1000);
    }
