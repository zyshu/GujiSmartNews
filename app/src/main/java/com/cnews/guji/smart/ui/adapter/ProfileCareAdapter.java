 ...
 * 视频数据装配
 */
public class ProfileCareAdapter extends BaseQuickAdapter<VideoNewsModel.Articles, BaseViewHolder> {
    private Context mContext;
    private int statusBarAcionBarHeight = 0;
//    private  VideoPlayerController controller;

    public ProfileCareAdapter(int layoutResId, List<VideoNewsModel.Articles> data) {
        super(layoutResId, data);
    }

    public ProfileCareAdapter(Context context, int layoutResId, List<VideoNewsModel.Articles> data) {
        super(layoutResId, data);
        mContext = context;
