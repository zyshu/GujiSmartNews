 ...
 * 头条推荐
 */
public class HomeYLFragment extends BaseFragment implements HeaderView.RefreshDistanceListener, HomeHotTopContract.View, OnRefreshListener {
    private static int SIZE = 20;
    private int mStartPage = 1;
    private Context mContext;
    private static final String TAG = HomeYLFragment.class.getSimpleName();
    ...
    private String TAG1 = HomeYLFragment.class.getSimpleName();


    public static HomeYLFragment getInstance(String title, int homeHotType) {
        HomeYLFragment homeHotTopFragment = new HomeYLFragment();
